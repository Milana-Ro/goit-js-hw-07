...
// через інлайн-стиль по кліку на button.change-color і задає
...
// у hex-форматі, в той час як колір фону на <body> буде у
// форматі rgb. Це нормально й не потребує якихось правок.

// На що буде звертати увагу ментор при перевірці:

// Фон на <body> задається тільки після кліку на
// button.change-color
// При кожному кліку на елемент button.change-color фон
// <body> зафарбовується новим рандомним кольором
