...
// елементів. Після натискання на кнопку Create має рендеритися
...
// провалідувати значення в input, воно має бути в межах від
// 1 до 100 включно. Тільки якщо воно задоволяє умову, мають
...
// зберігає кількість елементів для рендеру.
...
// повністю прибираються і замість них додаються нові у кількості,
// що вказана в input. Значення input очищається
// Усі квадрати в div#boxes різнокольорові і мають фон випадкового
// кольору
// Перший квадрат у div#boxes має розміри 30px на 30px, а кожен
